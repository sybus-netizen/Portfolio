...
export default function About() {
  ...
  return (
    <section id="about" className="py-12 sm:py-16 md:py-20 border-t border-slate-200 dark:border-white/5 bg-slate-100/50 dark:bg-[#111827]/40 relative overflow-hidden">
